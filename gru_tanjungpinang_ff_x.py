...
data_ff_x_tgpinang = pd.read_csv(link_data_set)
...
# Load model
model_filename='GRU_FF_X_TGPINANG.keras'
model = tf.keras.models.load_model(model_filename)

def predict_ff_x_tgpinang(input_data):
...
def predict_original_data_ff_x_tgpinang(input_data) :
...
def predict_multiple_day_ff_x_tgpinang(day):
    data_y= Y_test
    ...
    for i in range(day):
        ...
        prediction = predict_ff_x_tgpinang(input_x)
